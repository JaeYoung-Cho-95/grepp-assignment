...
import os
from assignment.config import database_config
from assignment.config import jwt_config
...
SECRET_KEY = 'django-insecure-=8(roaxif%pqqbgpdszdx9sxm$x5mt(s^0^slhnduht^0sup$s'
